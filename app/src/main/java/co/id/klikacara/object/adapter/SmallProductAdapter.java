...
public class SmallProductAdapter extends AbstractItem<SmallProductAdapter, SmallProductAdapter.ViewHolder> {

    private BaseProduct product;

    public SmallProductAdapter(BaseProduct product) {
    ...
    public int getLayoutRes() {
        return R.layout.adapter_product_small;
    }
