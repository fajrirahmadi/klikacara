...
class AutoScrollPager : ViewPager {
    ...
    companion object {
        ...
        private class MyHandler(autoScrollViewPager: AutoScrollPager) : Handler() {

            private val autoScrollViewPager: WeakReference<AutoScrollPager> = WeakReference(autoScrollViewPager)
