...
class ProfileActivity : BaseActivity(), MainContract.ProfileView,
    ...
    private fun handleOnMenuClicked(code: Int) {
        when (code) {
            codeEditProfile -> {
                showActivity(getIntent(this, ProfileDetailActivity::class.java))
            }
            codeProduct -> {
                showActivity(getIntent(this, MyProductActivity::class.java))
            }
            codeChangePassword -> {
                showActivity(getIntent(this, ChangePasswordActivity::class.java))
            }
            codeAbout -> {
            ...
            codeContactUs -> {
                showActivity(getIntent(this, ContactActivity::class.java))
            }
            codeLogout -> {
    ...
    fun onRegisterVendorClicked() {
        showActivity(getIntent(this, RegistrationActivity::class.java))
    }
    ...
    fun onVerifyButtonClicked() {
        showActivity(getIntent(this, VerifyVendorActivity::class.java))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profilePresenter.initAuthHelper(this)
